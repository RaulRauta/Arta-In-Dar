  ...
  return <main>
    <section className="hero relative flex min-h-[760px] items-end overflow-hidden bg-ink text-cream lg:min-h-screen">
      ...
      <div className="shell relative z-10 pb-16 pt-36 lg:pb-20"><div className="max-w-4xl">
        ...
        <h1 className="font-display text-[clamp(4.3rem,11vw,10.8rem)] leading-[1.04] tracking-[-.04em]">Arta ne<br /><span className="ml-[.12em] italic text-gold">unește.</span></h1>
    ...
    <section className="bg-olive py-24 text-cream lg:py-32"><div className="shell grid items-center gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-20"><Reveal><p className="eyebrow text-gold">Oamenii care au spus „da”</p><h2 className="mt-5 font-display text-6xl leading-[1.06] tracking-[-.025em] md:text-8xl">Primul nostru<br /><em className="text-gold">voluntar.</em></h2><p className="mt-8 font-display text-3xl">Di. Gheorghe Jitaru</p><p className="mt-3 max-w-sm text-cream/65">Un început se măsoară uneori într-un singur om care alege să fie acolo.</p></Reveal><Reveal delay={.1}><ArchiveImage type="portrait" label="Di. Gheorghe Jitaru, primul voluntar al asociației" /></Reveal></div></section>
    ...
    <section className="bg-terracotta py-24 text-cream lg:py-32"><div className="shell grid items-center gap-12 lg:grid-cols-2 lg:gap-20"><Reveal><ArchiveImage type="volunteer" label="Tricourile voluntarilor Arta în dar" /></Reveal><Reveal delay={.1}><p className="eyebrow text-gold">Munca voluntară · Arta la țară</p><h2 className="mt-5 font-display text-6xl leading-[1.06] tracking-[-.025em] md:text-8xl">În fiecare<br /><em>sâmbătă.</em></h2><p className="mt-8 max-w-md text-xl leading-relaxed text-cream/75">Program de muncă voluntară în fiecare sâmbătă, de la ora 9 la ora 12.</p><Link href="/doneaza-fii-voluntar" className="button-light mt-9">Vino alături de noi <ArrowUpRight className="size-4" /></Link></Reveal></div></section>

    <section className="bg-olive py-20 text-cream"><div className="shell"><Reveal className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center"><div><p className="eyebrow text-gold">Povestea continuă</p><h2 className="mt-4 font-display text-5xl leading-[1.08] tracking-[-.025em] md:text-7xl">Să ne regăsim<br /><em>întru frumos.</em></h2></div><Link href="/doneaza-fii-voluntar" className="button-light w-fit">Fii parte din poveste <ArrowUpRight className="size-4" /></Link></Reveal></div></section>
