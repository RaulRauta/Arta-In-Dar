  ...
  return (
    <footer className="relative overflow-hidden bg-ink text-cream">
      ...
      <div className="shell py-16 lg:py-24">
        ...
        <div className="flex flex-col gap-3 pt-6 text-xs text-cream/45 sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} Asociația Arta în Dar</p><div className="flex gap-5"><Link href="/documente">Documente</Link><Link href="/contact">Contact</Link></div></div>
      </div>
    </footer>
  );
}
