  ...
  fields: [
    ...
    defineField({
      ...
      of: [
        ...
        { type: "newsTemplateIntroImage" },
        { type: "newsTemplateGalleryStory" },
        { type: "newsTemplateImageTextImage" },
        { type: "newsTemplateJournal" },
        { type: "newsTemplateQuoteContext" },
        { type: "newsTemplateAnnouncement" },
        { type: "newsTemplatePhotoReport" },
        { type: "newsTemplateQa" },
        { type: "newsTemplateLandmarks" },
        { type: "newsTemplateClosingCta" },
      ],
